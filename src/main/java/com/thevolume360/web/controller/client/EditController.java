...
public class EditController {
	...
	public String update(@Valid Client client, BindingResult result, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("updateMessage", String.format("Client details successfully updated"));
		return "redirect:/client/show/"+client.getId();
	}
